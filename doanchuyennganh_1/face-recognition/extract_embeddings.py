# """
# Trích xuất embedding từ dataset/processed để train SVM.
...
#     person_dirs = [p for p in Path(PROCESSED_DATASET_DIR).iterdir() if p.is_dir()]
#     if not person_dirs:
#         print(f"Chưa có dataset processed trong: {PROCESSED_DATASET_DIR}")
#         print("Hãy chạy trước: python prepare_dataset.py")
#         return
...
#         print(f"  [OK] {label}: {ok_count} embedding")
...
#     print("\nHoàn thành trích xuất embedding.")
