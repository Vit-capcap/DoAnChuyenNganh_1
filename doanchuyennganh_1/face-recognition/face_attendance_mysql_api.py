    ...
    for r in results:
        for b in r.boxes:
            ...
            if face is None or face.size == 0:
                ...
                continue
# ArcFace/DeepFace tạo embedding
            ...
            if emb is None:
                ...
                continue
# SVM dự đoán sinh viên
# Embedding khuôn mặt
# → SVM tính xác suất thuộc từng sinh viên
# → chọn class có xác suất cao nhất
# → LabelEncoder đổi class đó thành mã/tên sinh viên
