  ...
  if (loading) {
    return (
      <StudentLayout
        ...
        subtitle="Personal Profile Management"
        showSearch={false}
      >
      ...
      <div className="max-w-[1500px] mx-auto">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
          ...
          <div className="xl:col-span-8 flex flex-col gap-6">
            ...
            {/* PERSONAL INFO */}
            <SectionCard title="Thông tin cá nhân" icon="badge">
            ...
            {/* ACCOUNT SECURITY */}
            <SectionCard title="Bảo mật tài khoản" icon="security">
